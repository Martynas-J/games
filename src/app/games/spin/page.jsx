  ...
  return (
    <div className="relative">
      ...
      <div className="flex justify-between items-center mb-5">
        <div className={`text-lg w-10 h-10 ${momentMoney >= 10000 ? "text-xl font-bold text-red-700" : momentMoney >= 1000 ? "text-xl font-semibold text-green-500" : ""}`}>{momentMoney > 0 && "+" + formatLargeNumber(momentMoney) + "€"}</div>
        <div
